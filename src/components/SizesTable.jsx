...
const SizesTable = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      sizes: [
        ["XS", "54 cm", "51 cm", "65 cm"],
        ["S", "57 cm", "54 cm", "68 cm"],
        ["M", "60 cm", "57 cm", "71 cm"],
        ["L", "63 cm", "60 cm", "74 cm"],
        ["XL", "66 cm", "63 cm", "77 cm"],
        ["2XL", "69 cm", "66 cm", "79 cm"],
      ]
    },
    {
      name: t("hoodie"),
    ...
    },
    {
      ...
      sizes: [
        ["XS", "51 cm", "53 cm", "67 cm"],
        ["S", "54 cm", "56 cm", "69 cm"],
        ["M", "57 cm", "59 cm", "71 cm"],
        ["L", "60 cm", "62 cm", "73 cm"],
        ["XL", "63 cm", "65 cm", "75 cm"],
      ]
    },
    {
      name: t("shorts"),
      ...
      sizes: [
        ...
        ["US 29", "72 cm", "104 cm", "51 cm"],
        ["US 30", "75 cm", "108 cm", "52 cm"],
        ["US 32", "78 cm", "112 cm", "53 cm"],
        ["US 33", "80 cm", "116 cm", "54 cm"],
        ["US 34", "82 cm", "120 cm", "55 cm"],
